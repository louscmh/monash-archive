...
/**
 * A class that represents a Salamander Volcano Tile in the Fiery Dragons game.
 *
 * Created by:
 * @author Kerk Han Chin
 */
public class SalamanderVolcanoTile extends VolcanoTile{
    /**
     * Constructor
     *
     * Created by:
     ...
     * is currently atop to be a Salamander Volcano Tile.
