...
/**
 * A class that represents a Swap Dragon Card in the Fiery Dragons game.
 *
 * Created by:
...
public class SwapDragonCard extends DragonCard{
     ...
     *
     */
    public SwapDragonCard(int animalCount, Image displayImage) {
    ...
    public void flipAccept(FlipVisitor flipVisitor) {
        flipVisitor.flipSwapDragonCard(this);
    }
