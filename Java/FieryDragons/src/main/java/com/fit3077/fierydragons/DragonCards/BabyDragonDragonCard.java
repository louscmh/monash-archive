...
/**
 * A class that represents a Baby Dragon Dragon Card in the Fiery Dragons game.
 *
 * Created by:
 * @author Kerk Han Chin
 */
public class BabyDragonDragonCard extends DragonCard{
    /**
     * Constructor
     *
     * Created by:
     ...
     */
    public BabyDragonDragonCard(int animalCount, Image displayImage) {
    ...
    public void flipAccept(FlipVisitor flipVisitor) {
        flipVisitor.flipBabyDragonDragonCard(this);
    }
    ...
    /**
     * This moveChecking handles the case where a baby dragon dragon card was flipped and the
     * player's dragon token's current position is that of a baby dragon volcano tile (a.k.a. matching animals).
    ...
    /**
     * This moveChecking handles the case where a baby dragon dragon card was flipped and the
     * player's dragon token's current position is that of a salamander volcano tile (a.k.a. non-matching animals).
