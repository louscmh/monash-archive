...
/**
 * A class that represents a Baby Dragon Volcano Tile in the Fiery Dragons game.
 *
 * Created by:
 * @author Kerk Han Chin
 */
public class BabyDragonVolcanoTile extends VolcanoTile{
    /**
     * Constructor
     *
     * Created by:
     ...
     * is currently atop to be a Baby Dragon Volcano Tile.
