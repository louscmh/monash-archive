...
/**
 * A class that represents a Spider Dragon Card in the Fiery Dragons game.
 *
 * Created by:
 * @author Kerk Han Chin
 */
public class SpiderDragonCard extends DragonCard{
    /**
     * Constructor
     *
     * Created by:
     ...
     *
     */
    public SpiderDragonCard(int animalCount, Image displayImage) {
    ...
    public void flipAccept(FlipVisitor flipVisitor) {
        flipVisitor.flipSpiderDragonCard(this);
    }
    ...
    /**
     * This moveChecking handles the case where a spider dragon card was flipped and the
    ...
    /**
     * This moveChecking handles the case where a spider dragon card was flipped and the
     * player's dragon token's current position is that of a spider volcano tile (a.k.a. matching animals).
