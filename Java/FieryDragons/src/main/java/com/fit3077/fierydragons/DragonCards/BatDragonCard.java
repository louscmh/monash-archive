...
/**
 * A class that represents a Bat Dragon Card in the Fiery Dragons game.
 *
 * Created by:
 * @author Kerk Han Chin
 */
public class BatDragonCard extends DragonCard{
    /**
     * Constructor
     *
     * Created by:
     ...
     *
     */
    public BatDragonCard(int animalCount, Image displayImage) {
    ...
    public void flipAccept(FlipVisitor flipVisitor) {
        flipVisitor.flipBatDragonCard(this);
    }
    ...
    /**
     * This moveChecking handles the case where a bat dragon card was flipped and the
    ...
    /**
     * This moveChecking handles the case where a bat dragon card was flipped and the
     * player's dragon token's current position is that of a bat volcano tile (a.k.a. matching animals).
